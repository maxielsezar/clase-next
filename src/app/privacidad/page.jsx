...
/>
      ...
      <section className="space-y-6 leading-relaxed">
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2 text-gray-900">1. Información que recopilamos</h2>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2 text-gray-900">2. Uso de la información</h2>
          <ul className="list-disc list-inside space-y-1">
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2 text-gray-900">3. Compartir información con terceros</h2>
          <p>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2 text-gray-900">4. Cookies y tecnologías similares</h2>
          <p>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2 text-gray-900">5. Seguridad de los datos</h2>
          <p>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2 text-gray-900">6. Enlaces a sitios de terceros</h2>
          <p>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2 text-gray-900">7. Derechos del usuario</h2>
          <p>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2 text-gray-900">8. Cambios en esta política</h2>
          <p>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-2 text-gray-900">9. Contacto</h2>
          <p>
