...
import Input from "@/app/componentes/Styled-Components2";
...
<div className="text-black flex justify-center text-3xl">Crea tu curriculum vitae y de esta manera quedas <br /> postulado para ofertas laborales presentes y futuras</div>
<br />
